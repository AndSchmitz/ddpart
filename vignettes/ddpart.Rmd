...
calculation of atmospheric stability conditions (Monin-Obukhov-Length) and friction
velocity via the Pasquill class approach. This has the advantage that widely
available meteorological measurements (or modelled data) can be used as an input (e.g.
wind speed, solar radiation, etc.). If this is not required because direct data
