...
# Part 1: Vertical wind speed profile
...
# Part 2: Dry deposition process

Emerson et al. (2020) figures 1 and 2 show the dry deposition velocity as a function of particle diameter for different settings (i.e. for different land use types, friction velocity, etc.). In the following, these figures are reproduced as a validation of the functions in the drydep package.

## A) Contributions from collection efficiencies

Emerson et al. (2020) figure 2B shows the contribution of the four dry deposition sub-processes (Brownian motion, interception, impaction and gravitational settling) to the total dry deposition velocity. This figure is reconstructed with functions from the drydep package. The parametrization for this example according to Emerson et al. (2020) is:

 - Friction velocity = 0.4 m/s
 
 - LUC: Evergreen needle leaf forest
...
#Define vector of particle diameters for X-axis
...
InputTable <- data.frame(
  ...
  RoughnessLengthAnemometer_m = 0.01,
  ZeroPlaneDisplacementHeightAnemometer_m = 7 * 0.01,
  WindSpeedAtAnemometerHeight_ms = 2,
  AnemometerHeight_m = 10,
  SunAngle_degree =  20,
  T_air_K = 273 + 20,
  RelHum_percent = 70,
  AirPressure_Pa = 1013.25 * 100,
  GlobalRadiation_W_m2 = 500,
  CloudCover_percent = 20,
  Season = 1, #midsummer
  WindSpeedBlendingHeight_m = 50,
  TargetLUCCodeZhang2001 = 1, #Evergreen needle leaf
  ReferenceHeight_m = 20,
  RoughnessLengthTargetLUC_m = 1.05,
  ZeroPlaneDisplacementHeightTargetLUC_m = 0.7 * 20,
  #Particle properties
